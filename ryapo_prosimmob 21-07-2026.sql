...
ALTER TABLE `abonnements`
  ...
  ADD KEY `idx_agence_id` (`agence_id`),
  ADD KEY `idx_ancien_abonnement` (`ancien_abonnement_id`),
  ADD KEY `idx_nouvel_abonnement` (`nouvel_abonnement_id`),
  ADD KEY `idx_code_abonnement` (`code_abonnement`),

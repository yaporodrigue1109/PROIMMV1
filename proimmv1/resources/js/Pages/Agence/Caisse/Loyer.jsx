    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const response = await fetch('/agence/caisse/loyer/pay', {
                ...
                body: JSON.stringify({
                    locataire_agence_id: selectedRental.locataire_agence_id,
            ...
            if (!response.ok || !payload?.success) {
                throw new Error(payload?.message ?? 'Le paiement a échoué.');
            }
                                        ...
                                        {selectedRental.history.map((item) => (
                                            ...
                                            >
                                                ...
                                                <div className="text-right">
                                                    ...
                                                    <p className="text-xs text-[#5f7182]">{item.className || '—'}</p>
                                                </div>
                                            </div>
                                        ))}
                                    </div>

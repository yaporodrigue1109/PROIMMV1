...
{{--                        <span id="rental-status" class="badge danger">En retard</span>--}}
{{--                    </div>--}}
...
{{--                    period: 'Mai 2026',--}}
{{--                    due: 60000,--}}
{{--                    lastPayment: '20/05/2026',--}}
{{--                    delay: 'Paiement partiel',--}}
{{--                    status: 'Partiel',--}}
{{--                    paymentStatus: {--}}
...
{{--            //--}}
{{--            //     const tenantName = normalizeSearch(staticTenant.name);--}}
{{--            //     const tenantPhone = normalizeSearch(staticTenant.phone).replace(/\D/g, '');--}}
{{--            //     const searchedPhone = value.replace(/\D/g, '');--}}
{{--            //--}}
{{--            //     const matchName = tenantName.includes(value);--}}
{{--            //     const matchPhone = searchedPhone.length >= 2 && tenantPhone.includes(searchedPhone);--}}
{{--            //--}}
{{--            //     tenantLoading.classList.add('d-none');--}}
{{--            //--}}
...
{{--                try {--}}
{{--                    const res  = await fetch(`{{ route('agence.caisse.loyer.search') }}?q=${encodeURIComponent(this.value.trim())}`);--}}
{{--                    const json = await res.json();--}}

{{--                    tenantLoading.classList.add('d-none');--}}

{{--                    if (json.data) {--}}
{{--                        showTenantRentals(json.data);   // passe l'objet complet--}}
{{--                    }--}}
...
{{--        function showTenantRentals() {--}}
{{--            document.getElementById('tenant-name').textContent = staticTenant.name;--}}
{{--            document.getElementById('tenant-phone').textContent = staticTenant.phone;--}}

{{--            rentalCount.textContent = `${staticTenant.rentals.length} bien(s)`;--}}
{{--            rentalList.innerHTML = '';--}}

{{--            staticTenant.rentals.forEach((rental, index) => {--}}
...
{{--            fillRentalDetails(staticTenant.rentals[0]);--}}
...
{{--            document.getElementById('rental-title').textContent = rental.property;--}}
{{--            document.getElementById('rental-location').textContent = rental.location;--}}
{{--            document.getElementById('rental-status').textContent = rental.status;--}}
...
{{--            document.getElementById('tenant-due').textContent = formatAmount(rental.due);--}}
{{--            document.getElementById('tenant-last-payment').textContent = rental.lastPayment;--}}
{{--            document.getElementById('tenant-delay').textContent = rental.delay;--}}

{{--            const paymentStatus = document.getElementById('tenant-payment-status');--}}

{{--            paymentStatus.textContent = rental.paymentStatus.label;--}}
...
{{--                'payment-status-info'--}}
{{--            );--}}
{{--            paymentStatus.classList.add(rental.paymentStatus.className);--}}
...
{{--                        <strong class="${item.className}">${item.status}</strong>--}}

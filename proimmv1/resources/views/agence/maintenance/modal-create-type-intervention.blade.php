<div class="modal" data-modal="modal-add-type-intervention" aria-hidden="true">
    <div class="modal-box u-modal-sm">
        ...
        <div class="modal-body">
            <form action="{{route('agence.maintenance.type.store')}}" method="POST">
                @csrf
                <div class="form-grid u-form-single">
                    <div class="form-field">
                        ...
                        <x-ui.input
                                name="name"
                                type="text"
                                placeholder="Ex: Réparation, Entretien, Urgence..."
                                required
                        />
                    </div>
                    <div class="form-field">
                    ...
                    {{--                            <input type="number" name="duree_estimee" placeholder="Ex: 2" step="0.5" />--}}
                    {{--                        </div>--}}
                    <div class="form-field">

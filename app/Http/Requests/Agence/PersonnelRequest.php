...
class PersonnelRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'tel1'      => ['required', 'string', 'max:16', 'regex:/^\+[1-9]\d{7,14}$/'],
            'tel2'      => ['nullable', 'string', 'max:16', 'regex:/^\+[1-9]\d{7,14}$/'],
            'role_id'   => $roleRules,
    ...
    public function messages(): array
    {
        return [
            ...
            'tel1.regex'        => 'Le contact 1 doit être un numéro international valide avec son indicatif pays.',
            'tel2.regex'        => 'Le contact 2 doit être un numéro international valide avec son indicatif pays.',
